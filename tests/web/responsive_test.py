...
responsive_page = os.path.join(
    dirname, "../resources/test_pages/responsive_locators.html"
)
responsive_page_url = f"file://{responsive_page}"
responsive_iframe = os.path.join(
    dirname, "../resources/test_pages/responsive_iframe.html"
)
