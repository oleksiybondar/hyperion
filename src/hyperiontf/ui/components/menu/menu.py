...
from hyperiontf.ui.components.typing import SlotPredicate
...
class Menu(Button):
    ...
    def __init__(self, parent, locator, name: str):
        ...
        self.component_spec.slots = [
            SlotPolicyRule(SlotPredicate.ALL, Menu),
            SlotPolicyRule(SlotPredicate.LAST, Button),
        ]
